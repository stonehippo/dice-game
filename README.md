...
There's [a more compact Javascript dice-rolling implementation](https://github.com/stonehippo/ultra-lite-engine/blob/main/lib/ultralite/dice.js) in my (now archived) ultralite engine project. 
